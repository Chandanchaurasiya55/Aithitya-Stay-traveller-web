...
import { 
  ...
  Share2, ThumbsUp, Star, Home, LayoutDashboard, Menu, TrendingUp
} from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div className="w-full lg:w-[30%] lg:max-w-[30%] shrink-0 space-y-6">
          ...
          {/* Bottom System Info & Logout */}
          <div className="bg-white rounded-3xl p-4 border border-stone-200 text-center space-y-2">
            <div className="flex items-center justify-center gap-1.5 font-bold text-xs text-[#0F382C]">
              <ShieldCheck className="w-4 h-4 text-[#C8933E]" />
              <span>Atithya Stay Admin System</span>
            </div>
            {onAdminLogout && (
              <button
                type="button"
                onClick={onAdminLogout}
                className="w-full bg-red-50 hover:bg-red-600 text-red-700 hover:text-white border border-red-200 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center justify-center gap-2"
              >
        ...
        <div className="w-full lg:w-[70%] flex-1 space-y-6">
          ...
          {/* TAB 3: FULL TOUR PACKAGES CREATOR */}
          {activeTab === 'packages' && (
          ...
          {/* TAB 4: FULL HOTELS & RESORTS CREATOR */}
          {activeTab === 'hotels' && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          {/* TAB 5: FULL PAGE POST PUBLISHER */}
          {activeTab === 'posts' && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          {/* TAB 6: ANALYTICS DASHBOARD OVERVIEW */}
          {activeTab === 'overview' && (
            <div className="space-y-6">
              
              {/* 4 Stat Cards */}
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                <div className="bg-[#0F382C] text-white rounded-2xl p-5 shadow-lg border border-emerald-900 flex flex-col justify-between space-y-3">
                ...
                <div className="bg-white text-stone-800 rounded-2xl p-5 shadow-xs border border-stone-200 flex flex-col justify-between space-y-3">
                  <div className="flex items-center justify-between">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
                <div className="xl:col-span-8 bg-white rounded-2xl p-6 border border-stone-200 shadow-xs space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                    ...
                    <button 
                      ...
                      className="bg-[#C8933E] text-white px-3.5 py-1.5 rounded-xl text-xs font-bold hover:bg-[#b07f33]"
                    >
                      Check Now
                    </button>
                  </div>
                  ...
                  <div className="pt-6 pb-2 px-2 relative">
                    <div className="absolute top-0 left-[58%] -translate-x-1/2 bg-[#0F382C] text-[#C8933E] text-[10px] font-bold px-2 py-0.5 rounded-md shadow-sm border border-[#C8933E]/40">
                      26.71
                    </div>
                    <div className="h-44 flex items-end justify-between gap-2 border-b border-stone-200 pb-2">
                      {months.map((m, idx) => (
                        <div key={m} className="flex-1 flex items-end justify-center gap-1 h-full">
                          <div className="w-3 rounded-t-sm bg-[#0F382C]" style={{ height: `${greenBars[idx]}%` }} />
                          <div className="w-3 rounded-t-sm bg-[#C8933E]" style={{ height: `${amberBars[idx]}%` }} />
                        </div>
                      ))}
                    </div>
                ...
                <div className="xl:col-span-4 bg-white rounded-2xl p-6 border border-stone-200 shadow-xs flex flex-col justify-between space-y-4 text-center">
                  <div className="relative w-36 h-36 mx-auto flex items-center justify-center my-2">
                    <svg className="w-full h-full transform -rotate-90" viewBox="0 0 100 100">
                      ...
                      <circle cx="50" cy="50" r="40" stroke="#0F382C" strokeWidth="12" fill="transparent" strokeDasharray="251.2" strokeDashoffset="60" strokeLinecap="round" />
                      <circle cx="50" cy="50" r="40" stroke="#C8933E" strokeWidth="12" fill="transparent" strokeDasharray="251.2" strokeDashoffset="190" strokeLinecap="round" />
                    </svg>
                  ...
                  <button 
                    ...
                    className="w-full bg-[#C8933E] text-white py-2 rounded-xl text-xs font-bold hover:bg-[#b07f33]"
                  >
                    Check Now
                  </button>
                </div>
